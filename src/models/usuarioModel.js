...
function autenticar(nome, email, senha) {
    ...
    var instrucaoSql = `
        SELECT idFuncionario, fkEmpresa as empresaId, username, nomeCompleto ,email,  fkTipoFuncionario FROM funcionario WHERE email = '${email}' AND senha = '${senha}' AND username = '${nome}';
    `;
